...
行为经济学将心理学的见解融入经济模型，用以解释偏离理性选择理论的行为。

### 认知偏差

### 前景理论

前景理论描述了人们在风险条件下如何做出决策，表明人们对收益和损失存在不对称的反应。

### 应用

## 结论

该框架为组织经济学研究和教学提供了一种结构。空白部分表明了未来扩展的领域。
