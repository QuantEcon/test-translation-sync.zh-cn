...
kernelspec:
  ...
  name: python3
heading-map:
  Programming for Economics: 编程在经济学中的应用
...
[QuantEcon](https://quantecon.org) 项目提供了专门用于经济建模的工具。访问[文档](https://quanteconpy.readthedocs.io/)以获取详细信息。
...
- **答**：`numpy` 在数值运算中通常快 10-100 倍

- **问**：我可以对大型数据集使用 `pandas` 吗？
