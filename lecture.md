...
*Matplotlib* 是 Python 的基础绘图库。它提供了对图形外观的细粒度控制。
...
[QuantEcon](https://quantecon.org) 项目提供了经济建模的专用工具。访问[文档](https://quanteconpy.readthedocs.io/)了解详情。
...
- **答**：可以，但对于超过RAM大小的数据集，建议考虑使用`dask`
