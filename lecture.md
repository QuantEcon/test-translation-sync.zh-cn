...
**pandas** 库提供了强大的数据处理功能。DataFrames 是二维标记数据结构。
...
[QuantEcon](https://quantecon.org) 项目提供了用于经济建模的专业工具。访问[文档](https://quanteconpy.readthedocs.io/)以获取详细信息。
