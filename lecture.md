...
translation:
  ...
  headings:
    ...
    Working with **Pandas DataFrames**: 使用 **Pandas DataFrame**
...
**pandas** 库提供了强大的数据处理能力。DataFrame 是二维带标签数据结构。
...
[QuantEcon](https://quantecon.org) 项目提供了专门用于经济建模的工具，请访问[文档](https://quanteconpy.readthedocs.io/) 了解详细信息。
...
像 **numpy**、*pandas* 和 `matplotlib` 这样的编程工具对现代经济学研究至关重要。掌握这些库可以帮助你高效地分析数据和可视化结果。
